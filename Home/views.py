...
def Save_signup(request):
    ...
    signup_obj = Student(Name=Name, Email=Email, Password=Password, Gender=Gender, Mobile=Mobile, DOB=DOB,
                         Course=Course)
    signup_obj.save()
    return render(request, 'index.html', {"msgs": "Signup Successfully"})
...
def Student_Login(request):
    if request.POST:
        ...
        if data_len == 1:
            ...
            return render(request, 'index.html', {'msgg': 'Invalid Login Details'})
...
def Teacher_signup(request):
    ...
    signup_obj = Teacher(Name=Name, Email=Email, Password=Password, Gender=Gender, Mobile=Mobile, DOB=DOB,
                         Subject=Subject)
    signup_obj.save()
    return render(request, 'index.html', {"Tmsg": "Signup Successfully"})
...
def Teacher_Login(request):
    if request.POST:
        ...
        if data_len == 1:
            ...
            return render(request, 'index.html', {'Mmsg': 'Invalid Login Details'})
